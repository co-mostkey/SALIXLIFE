...
export default function CompetitiveAdvantageSlide() {
  ...
  const slideData = tTech('slides.competitiveAdvantage') || {};
  const competitiveAdvantageData = slideData.competitiveAdvantageData || {};
  const comparisonData = competitiveAdvantageData.data || [];
  const advantages = competitiveAdvantageData.advantages || [];
          ...
          >
            ...
            >
              ...
              <span className="text-xs font-medium text-gray-800 tracking-wider uppercase">
                {competitiveAdvantageData.subtitle || 'Competitive Advantage'}
              </span>
            </motion.div>
            ...
            >
              <span className="font-extralight text-gray-600">{competitiveAdvantageData.titleParts?.prefix || '경쟁'}</span>{' '}
              <span className="font-medium bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 bg-clip-text text-transparent">
                {competitiveAdvantageData.titleParts?.main || '우위'}
              </span>
            </motion.h1>
            ...
            >
              {competitiveAdvantageData.description || '경쟁사 대비 압도적인 성능과 혁신적인 기술력을 확인하세요'}
            </motion.p>
          </motion.div>
                ...
                <div className="relative bg-transparent backdrop-blur-xl border border-white/50 rounded-2xl p-4 shadow-xl hover:shadow-2xl transition-all duration-500 h-full min-h-[200px]">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="px-2 py-0.5 bg-transparent backdrop-blur-sm border border-white/60 rounded-full shadow-sm">
                      <span className="text-xs font-medium text-gray-700">
                        {competitiveAdvantageData.common?.advantage || '우위 확보'}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    <p className="text-sm text-gray-600 font-light">
                      vs {competitiveAdvantageData.common?.competitors || '경쟁사'} {item.theirValue}
                    </p>
                  </div>
                  ...
                  <div className="mb-3">
                    <div className="flex justify-between text-xs text-gray-600 mb-2">
                      <span>{competitiveAdvantageData.common?.ours || 'SALIX O²'}</span>
                      <span>{competitiveAdvantageData.common?.competitors || '경쟁사'}</span>
                    </div>
                    <div className="relative h-2 bg-gray-200 rounded-full overflow-hidden">
                      ...
                      <motion.div
                        ...
                        className="absolute top-0 right-0 h-full bg-gray-400 rounded-full"
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-600 font-medium">{competitiveAdvantageData.common?.performanceVerification || '성능 검증'}</span>
                      </div>
